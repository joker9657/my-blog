                ...
                <div class="pr-8 pt-2">
                    <div class="post py-10">
                        ...
                        <div class="post-content text-base leading-normal pt-5 text-justify break-normal">
                            这是一个特殊的春节假期。肆虐全国的SARI病毒搞得人心惶惶，网络和媒体上的各种言论也是盛嚣尘上。可我对这一切却显得漠然，从来不曾因为一些罪恶而怒发冲冠，也不会为了某些龌龊而杞人忧天，只是自顾自地珍惜这段全天候陪在家人身边
                        </div>
                        <p class="m-4">
                            <a href="" class="text-base my-1 py-1 px-2 border rounded border-gray-300 float-right">阅读全文</a>
                        </p>
                    </div>
                </div>
                <nav class="my-6 text-lg text-center">
                    <ul class="pagination">
                        {{-- Previous Page Link --}}
                        @if ($paginator->onFirstPage())
                            <li class="disabled hidden" aria-disabled="true"><span>首页</span></li>
                        @else
                        ...
                        @else
                            <li class="disabled hidden" aria-disabled="true"><span>下一页</span></li>
                        @endif
                    </ul>
                </nav>
            </div>
